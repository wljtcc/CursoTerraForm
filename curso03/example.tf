...
# Na orquestração é necessário criar um security list antes do sec. rules. Mas isso nào é 
# arbitrário no terraform. Por isso o sec. rules está na frente.
